...
</p></div></div><div class="bg-white px-12 py-3 group w-full col-span-2 row-span-2 relative" data-astro-cid-v2cbyr3p><div class="py-3 flex flex-col justify-between min-h-full" data-astro-cid-v2cbyr3p><img src="src/images/about/brian.png" data-astro-cid-v2cbyr3p></div></div><div class="bg-white px-12 py-3 group w-full col-span-4 row-span-2 relative" data-astro-cid-v2cbyr3p><div class="flex flex-col min-h-full py-3" data-astro-cid-v2cbyr3p><div class="pb-3" data-astro-cid-v2cbyr3p><p class="uppercase" data-astro-cid-v2cbyr3p>About this site</p></div><p data-astro-cid-v2cbyr3p>
