...
// run immediately after Astro swaps in new content
document.addEventListener('astro:after-swap', initCardEffects);

// run when all scripts and styles for the new page have finished loading
